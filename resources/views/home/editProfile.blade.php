      ...
      <div class="row">
        ...
        <div class="col-xl-8 order-xl-1">
          ...
          <div class="card">
            ...
            <div class="card-body">
              <form action="{{ session('level') == 'pengepul' ? '/editProfilePengepul' : '/editProfile' }}" method="POST">
                @csrf
                    ...
                    <div class="col-lg-6">
                      @if (session('level') != 'pengepul')
                        <div class="form-group">
                          ...
                          <input type="text" id="input-username" class="form-control" name="nama" placeholder="Username" value="{{ old('nama',$user->nama) }}">
                          @error('nama')
                      ...
                      @else
                        <div class="form-group">
                          ...
                          <input type="text" id="input-username" class="form-control" name="nama" placeholder="Username" value="{{ old('nama',$user->nama_petugas) }}">
                          @error('nama')
                              <span class="text-danger">{{ $message }}</span>
                          @enderror
                        </div>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <input id="input-address" class="form-control" name="alamat" placeholder="Home Address" value="{{ old('alamat',$user->alamat) }}" type="text">
                        @error('alamat')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                      </div>
                  ...
                  <div class="row">
                    <div class="col-lg-4">
                      <div class="form-group">
                        ...
                        <input type="number" id="no" class="form-control" placeholder="No telepon" name="no_telepon" value="{{ old('no_telepon',$user->no_hp) }}">
                        @error('no_telepon')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                      </div>
...
{{-- show hide password --}}
  ...
  {{-- <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAYnW2QhI8UCUA7RXpmdWnTszqGnLTHtvI&callback=initMap"></script> --}}
  <script>
    ...
    zoom: 12,
    center: new google.maps.LatLng(<?= explode(' ',$user->koordinat)[0] ?>, <?= explode(' ',$user->koordinat)[1] ?>),
    mapTypeId: google.maps.MapTypeId.ROADMAP
    });
    //posisi awal marker   
    var latLng = new google.maps.LatLng(<?= explode(' ',$user->koordinat)[0] ?>, <?= explode(' ',$user->koordinat)[1] ?>);
