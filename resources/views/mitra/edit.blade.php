...
<div class="main-content" id="panel">
      ...
      <div class="row">
        ...
        <div class="col-xl-8 order-xl-1">
          ...
          <div class="card">
            ...
            <div class="card-body">
              <form action="/mitra/edit" method="POST">
                @csrf
                <input type="hidden" name="id" value="{{ $mitra->id_user }}">
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="text" id="input-username" class="form-control" name="nama" placeholder="Username" value="{{ old('nama',$mitra->nama) }}">
                            @error('nama')
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="email" id="input-email" placeholder="Email" class="form-control" name="email" value="{{ old('email',$mitra->email) }}">
                        @error('email')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                      </div>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <input id="input-address" class="form-control" name="alamat" placeholder="Alamat" value="{{ old('alamat',$mitra->alamat) }}" type="text">
                        @error('alamat')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                      </div>
                  ...
                  <div class="row">
                    <div class="col-lg-4">
                      <div class="form-group">
                        ...
                        <input type="number" id="no" class="form-control" placeholder="No telepon" name="no_telepon" value="{{ old('no_telepon',$mitra->no_hp) }}">
                        @error('no_telepon')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                      </div>
  ...
  <script>
      ...
      zoom: 12,
      center: new google.maps.LatLng(<?= explode(' ',$mitra->koordinat)[0] ?>, <?= explode(' ',$mitra->koordinat)[1] ?>),
      mapTypeId: google.maps.MapTypeId.ROADMAP
      });
      //posisi awal marker   
      var latLng = new google.maps.LatLng(<?= explode(' ',$mitra->koordinat)[0] ?>, <?= explode(' ',$mitra->koordinat)[1] ?>);
